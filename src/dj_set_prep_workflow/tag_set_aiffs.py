...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Tag DJ set AIFF files using a metadata file.")
    parser.add_argument("set_dir", type=Path, help="Folder containing the set metadata file and AIFF files.")
    parser.add_argument(
        "--set-file",
        type=Path,
        default=None,
